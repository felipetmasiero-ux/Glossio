...
export const numbersLesson = {
    ...
    subtitle:
        "Conte de zero a cem e fale sobre idade em francês.",

    description:
        "Aprenda os números cardinais em francês e como usá-los para contar, informar telefone e falar de idade.",
