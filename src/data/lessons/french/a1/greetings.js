...
export const greetingsLesson = {
  ...
  title: "Cumprimentos",
  subtitle: "Aprenda a cumprimentar pessoas e iniciar conversas simples em francês.",
  description:
    "Aprenda como os falantes de francês se cumprimentam, formal e informalmente, e como se despedir educadamente.",
