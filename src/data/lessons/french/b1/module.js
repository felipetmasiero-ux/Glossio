...
export const frenchB1Module = {
    ...
    description:
        "Comunique-se com mais fluência em francês: experiências de vida, planos e metas, relacionamentos, trabalho, viagens, saúde, tecnologia, opiniões, meio ambiente, mídia e notícias.",
