...
export const restaurantA2Lesson = {
    ...
    subtitle:
        "Faça pedidos educados, peça uma refeição completa e lide com uma reserva de restaurante em francês.",

    description:
        "Vá além do pedido básico e aprenda a fazer pedidos educados com 'pourriez-vous', pedindo entrada, prato principal e sobremesa.",
